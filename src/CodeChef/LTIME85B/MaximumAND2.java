...
public class MaximumAND2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int t = 0; t < cases; t++) {
            ...
            prices = new Tuple[30];
            for (int i = 0; i < 30; i++) prices[i] = new Tuple(0, i);
...
//            out.println(Arrays.toString(prices));
            ...
            res = res.reverse();
//            out.println(res);
            result.append(Integer.parseInt(res.toString(), 2));
        }
        out.println(result);
    ...
    static class Tuple implements Comparable<Tuple> {
        ...
        public int compareTo(Tuple other) {
            if (this.a == other.a) return Integer.compare(other.b, this.b);
